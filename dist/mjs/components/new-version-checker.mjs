...
import { colorAmber200, colorAmber500, colorGreen900, colorWhite } from "../styling/colors.mjs";
...
export const NewVersionChecker = createMemoizedComponent('NewVersionChecker', function ({ currentVersion, message, className, action }) {
    ...
    const contents = (React.createElement("div", { id: "newVersionChecker", className: classes(newVersionCheckerClassName, (typeof window === 'undefined' || !newVersionAvailable) && newVersionCheckerHiddenClassName, className), "data-current-version": currentVersion },
