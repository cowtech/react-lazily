...
import { colorAmber200, colorAmber500, colorRed700, colorWhite } from "../styling/colors.mjs";
...
export const BrowseHappy = createMemoizedComponent('BrowseHappy', function ({ message, className }) {
    ...
    const contents = (React.createElement("div", { id: "browseHappy", className: classes(browseHappyClassName, typeof window === 'undefined' && browseHappyHiddenClassName, className) },
