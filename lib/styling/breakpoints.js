...
export const queryMaxWidth11xx = `(max-width: ${px(maxWidth11xx)})`;
//  iPhone 6 Plus (Landscape)
export const maxWidth8xx = 800;
export const queryMaxWidth8xx = `(max-width: ${px(maxWidth8xx)})`;
//  iPad Pro (Portrait 1/2, Portrait 2/3), iPad Air (Landscape 2/3), iPad Mini (Landscape 2/3)
// iPhone >4 (Landscape)
export const maxWidth7xx = 700;
export const queryMaxWidth7xx = `(max-width: ${px(maxWidth7xx)})`;
// iPad Air (Landscape 1/2), iPad Mini (Landscape 1/2)
// iPhone <5 (Landscape)
export const maxWidth6xx = 600;
export const queryMaxWidth6xx = `(max-width: ${px(maxWidth6xx)})`;
...
export const queryMaxWidth45x = `(max-width: ${px(maxWidth45x)})`;
// iPad Air (Portrait or Landscape 1/3), iPad Mini (Portrait or Landscape 1/3)
// iPhone 6 (Portrait)
// iPhone <6 (Portrait)
export const maxWidth38x = 380;
export const queryMaxWidth38x = `(max-width: ${px(maxWidth38x)})`;
// Large screens
export const maxHeight8xx = 800;
export const queryMaxHeight8xx = `(max-height: ${px(maxHeight8xx)})`;
// iPhone <5 (Landscape), iPhone 6 (Landscape), iPhone 6 Plus (Landscape)
export const maxHeight6xx = 600;
export const queryMaxHeight6xx = `(max-height: ${px(maxHeight6xx)})`;
