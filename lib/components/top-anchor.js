...
export const TopAnchor = createMemoizedComponent('TopAnchor', function ({ duration, backgroundColor, foregroundColor, className }) {
    ...
    return (React.createElement("a", { id: "topAnchor", ref: element, className: classes(topAnchorBaseClassName, topAnchorClassName, className), onClick: handleScrollToTop, href: "#top", title: "Top" },
