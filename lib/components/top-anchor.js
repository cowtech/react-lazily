...
export class TopAnchor extends React.PureComponent {
    constructor() {
        super(...arguments);
        ...
        this.boundHandleScrollToTop = this.handleScrollToTop.bind(this);
    }
    render() {
        this.element = React.createRef();
        return (React.createElement("a", { id: "topAnchor", ref: this.element, className: this.className, onClick: this.boundHandleScrollToTop, href: "#top", title: "Top" },
